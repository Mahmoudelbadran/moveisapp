import 'dart:convert';
MoviesPopularResponse moviesPopularResponseFromJson(String str) => MoviesPopularResponse.fromJson(json.decode(str));
class MoviesPopularResponse {
  ...
  MoviesPopularResponse.fromJson(dynamic json) {
    _page = json['page'];
